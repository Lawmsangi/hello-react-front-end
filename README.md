...
(Link to backend)[https://github.com/Lawmsangi/hello-rails-back-end/tree/add-backend]
...
```sh
  git clone https://github.com/Lawmsangi/hello-react-front-end.
...
Feel free to check the [issues page](https://github.com/Lawmsangi/hello-react-front-end/issues).
